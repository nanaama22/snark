     ...
     return (
          <div className="analytics-card">
               <div className="analytics">
                    ...
                    <div className="inner"><span className="inner-text">1,564</span></div>
                    </div>
               ...
               <div className="analytics">
                    ...
                    <div className="inner"><span className="inner-text-1">001</span></div>
                    </div>
                    <p className="analytics-desc">
               ...
               <div className="analytics">
                    ...
                    <div className="inner"><span className="inner-text-2">350</span></div>
                    </div>
                    <p className="analytics-desc">
