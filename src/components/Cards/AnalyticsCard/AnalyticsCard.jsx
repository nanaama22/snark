     ...
     return (
          <div className="analytics-card">
               <div className="analytics">
                    ...
                    <div className="inner"><span className="inner-texxt">1,564</span></div>
                    </div>
               ...
               <div className="analytics">
                    ...
                    <div className="inner"><span className="inner-textx-1">001</span></div>
                    </div>
                    <p className="analytics-desc">
               ...
               <div className="analytics">
                    ...
                    <div className="inner"><span className="inner-textxx-2">350</span></div>
                    </div>
                    <p className="analytics-desc">
